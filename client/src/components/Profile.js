  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      toast.promise(updatePromise, {
        loading: 'Updating...!',
        success: (res) => <b>Update Successfully</b>,
        error: (err) => <b>{err.error}</b>
      });

    }
  })

  // formik không hỗ trợ file upload, nên là phải tạo một handler này
        ...
        <div className={`${styles.glass} ${extend.glass}`} style={{width: "45%", paddingTop: '3em'}}>
          <div className='title flex flex-col items-center'>
            ...
            <span className='py-4 text-xl w-2/3 text-center text-gray-500'>
              You can update the details your information.
            </span>
          </div>
          ...
          <form className='py-1' onSubmit={formik.handleSubmit}>
            ...
            <div className='textbox flex flex-col items-center gap-6'>
              ...
              <div className='name flex w-3/4 gap-10'>
                <input {...formik.getFieldProps('phone')} className={`${styles.textbox} ${extend.textbox}`} type='text' placeholder='Mobile Phone' />
              ...
              <button className={styles.btn} type='submit'>Update Info</button>
            </div>
